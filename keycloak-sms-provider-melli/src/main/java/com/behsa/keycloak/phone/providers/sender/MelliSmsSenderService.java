package com.behsa.keycloak.phone.providers.sender;
...
public class MelliSmsSenderService extends FullSmsSenderAbstractService {

    private static final Logger logger = Logger.getLogger(MelliSmsSenderService.class);

    public MelliSmsSenderService(String realmDisplay) {
        super(realmDisplay);
    }
